...
export function MobileMenu() {
  ...
  return (
    <div className="md:hidden">
      ...
      {isOpen && (
        <div className="fixed inset-x-0 top-[60px] bottom-0 z-40 bg-white/98 dark:bg-[#0d0f13]/98 backdrop-blur-2xl border-b border-black/10 dark:border-white/10 overflow-y-auto p-5 animate-in fade-in duration-200 flex flex-col justify-between">
          <div className="space-y-4">
            ...
            {siteConfig.navigation.remoteControlBadge?.enabled && (
              <a
                ...
                className="flex items-center justify-between gap-2 p-3 rounded-2xl bg-blue-50 border border-blue-200 dark:bg-gradient-to-r dark:from-blue-600/20 dark:to-purple-600/20 dark:border-blue-500/30 text-blue-900 dark:text-white text-xs font-medium"
              >
          ...
          {/* Bottom Action with Theme Toggle & Download */}
